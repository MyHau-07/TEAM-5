...
def login_test(username, password):
    ...
    try:
        ...
        if driver.current_url == "http://127.0.0.1:8000/dentist_dashboard":  # Thay "dashboard" bằng URL thật sau đăng nhập
            return "success"
        else:
            return "fail"
